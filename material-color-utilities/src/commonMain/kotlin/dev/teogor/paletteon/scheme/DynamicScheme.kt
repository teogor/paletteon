...
import dev.teogor.paletteon.utils.MathUtils
...
public open class DynamicScheme(
  ...
  public var successPalette: TonalPalette = TonalPalette.fromHueAndChroma(
    hue = 120.0, chroma = 84.0
  )
  public var warningPalette: TonalPalette = TonalPalette.fromHueAndChroma(
    hue = 60.0, chroma = 84.0
  )
  public var errorPalette: TonalPalette = TonalPalette.fromHueAndChroma(
    hue = 25.0, chroma = 84.0
  )
