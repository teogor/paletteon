...
public class MaterialDynamicColors(
    ...
    tone = { scheme ->
      when {
        ...
        !isFidelity(scheme) -> if (scheme.isDark) 30.0 else 90.0
          ...
          dev.teogor.paletteon.dislike.DislikeAnalyzer.fixIfDisliked(proposedHct).tone
        }
      }
    },
    isBackground = true,
  ...
  public fun success(): DynamicColor = DynamicColor(
    name = "success",
    palette = { scheme -> scheme.successPalette },
    tone = { scheme -> if (scheme.isDark) 80.0 else 40.0 },
    isBackground = true,
    background = { scheme -> highestSurface(scheme) },
    secondBackground = null,
  ...
  public fun onSuccess(): DynamicColor = DynamicColor(
    name = "on_success",
    palette = { scheme -> scheme.successPalette },
    tone = { scheme -> if (scheme.isDark) 20.0 else 100.0 },
    isBackground = false,
  ...
  public fun successContainer(): DynamicColor = DynamicColor(
  ...
  public fun onSuccessContainer(): DynamicColor = DynamicColor(
  ...
  public fun warning(): DynamicColor = DynamicColor(
    name = "warning",
    palette = { scheme -> scheme.warningPalette },
    tone = { scheme -> if (scheme.isDark) 80.0 else 40.0 },
    isBackground = true,
    background = { scheme -> highestSurface(scheme) },
    secondBackground = null,
  ...
  public fun onWarning(): DynamicColor = DynamicColor(
    name = "on_warning",
    palette = { scheme -> scheme.warningPalette },
    tone = { scheme -> if (scheme.isDark) 20.0 else 100.0 },
    isBackground = false,
  ...
  public fun warningContainer(): DynamicColor = DynamicColor(
  ...
  public fun onWarningContainer(): DynamicColor = DynamicColor(
