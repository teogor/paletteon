...
public fun ContrastSvg(
  ...
  Svg(attrs = svgAttrs) {
    Path {
      d {
        moveTo(12.0f, 0.0f)
        curveTo(5.3711f, 0.0f, 0.0f, 5.3711f, 0.0f, 12.0f)
        curveTo(0.0f, 18.6289f, 5.3711f, 24.0f, 12.0f, 24.0f)
        curveTo(18.6289f, 24.0f, 24.0f, 18.6289f, 24.0f, 12.0f)
        curveTo(24.0f, 5.3711f, 18.6289f, 0.0f, 12.0f, 0.0f)
        closePath()
        moveTo(12.0f, 22.0f)
        lineTo(12.0f, 2.0f)
